<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="IngresarMedidor.aspx.cs" Inherits="MedidoresDM.IngresarMedidor" %>
        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="bebidaDdl">Tipo de Medidor</label>
                        <asp:DropDownList runat="server" ID="bebidaDdl" CssClass="form-select" AppendDataBoundItems="true">
